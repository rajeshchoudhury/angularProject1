...
feature "Submitting a patient", js: true do
	before do
  ...
  scenario "should be able to open the patient modal" do
    visit '/'
    click_on "New Client"
    expect(page).to have_content("New Client")
  end

  scenario "should fail to submit a patient with no name" do
    visit '/'
    click_on "New Client"
    click_on "Save Changes"
    expect(page).to have_content("Please, check all the required fields.")
  end
end