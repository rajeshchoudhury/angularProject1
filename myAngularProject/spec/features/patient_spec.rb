...
feature "Adding new patient", js: true do
	before do
  ...
  scenario "should be able to open modal" do
    visit '/'
    click_on "New Client"
    expect(page).to have_content("Basic Information")
  end

  scenario "should be able to close modal" do
    visit '/'
    click_on "New Client"
    click_on "Cancel"
    expect(page).to have_no_content("Basic Information")
  end

  scenario "should be able to create new user" do
    visit '/'
    click_on "New Client"
    fill_in "name", with: "John Doe"
    fill_in "email", with: "jonh@gmail.com"
    fill_in "birth", with: "12341234"
